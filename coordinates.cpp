...
void coordinates::level(int difficulty){

    if( difficulty == 13 )
        placeCardsEasy(475, 650, difficulty);
    if( difficulty == 26 )
        placeCardsMedium(120, 720, difficulty);
    if( difficulty == 39 )
        placeCardsHard(5, 740, difficulty);
    if( difficulty == 52 )
        placeCardsHardcore(70, 790, difficulty);

}

void coordinates::placeCardsEasy(int x, int y, int cards){
...
void coordinates::placeCardsMedium(int x, int y, int cards){
...
void coordinates::placeCardsHard(int x, int y, int cards){
...
void coordinates::placeCardsHardcore(int x, int y, int cards){
