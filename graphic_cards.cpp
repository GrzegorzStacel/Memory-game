...
QString graphic_cards::setImageRegularNeutral(int number){
    ...
    switch (number+1) {
        ...
        case 52: return ":/others/images/cards/easy, medium, hard/diamond/Neutral/as_diamond_neutral.png";
...
QString graphic_cards::setImageRegularWrong(int number){
...
QString graphic_cards::setImageRegularCorrect(int number){
    ...
    switch (number+1) {
        ...
        // diamond - only for traverse_visibility_management
        case 52: return ":/others/images/cards/easy, medium, hard/diamond/Correct/as_diamond__correct.png";
...
QString graphic_cards::setImageVeryHardNeutral(int number){
...
QString graphic_cards::setImageVeryHardWrong(int number){
...
QString graphic_cards::setImageVeryHardCorrect(int number){
